        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="grid grid-cols-2 gap-2 bg-gray-50 p-1 rounded-xl border border-gray-100">
            <button
              ...
              className={`py-2 text-xs font-semibold rounded-lg transition-all cursor-pointer ${role === 'farmer' ? 'bg-green-600 text-white shadow' : 'text-gray-600 hover:bg-gray-100'
                }`}
            >
              விவசாயி (Farmer)
            </button>
            <button
              ...
              className={`py-2 text-xs font-semibold rounded-lg transition-all cursor-pointer ${role === 'msme' ? 'bg-blue-600 text-white shadow' : 'text-gray-600 hover:bg-gray-100'
                }`}
            >
              MSME / ஆய்வாளர்
            </button>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-3 ${role === 'farmer' ? 'bg-green-600 hover:bg-green-700' : 'bg-blue-600 hover:bg-blue-700'
